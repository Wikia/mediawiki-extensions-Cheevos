(function(mw, $) {
	...
	TriggerBuilder.prototype = {
		...
		deleteTrigger: function() {
			...
			var deleteTrigger = $('<img>').attr('src', mw.config.get('wgExtensionAssetsPath')+'/Cheevos/images/delete.png').attr('title', mw.message('delete_trigger').escaped()).addClass('delete_trigger');
		...
		deleteCondition: function() {
			var deleteCondition = $('<img>').attr('src', mw.config.get('wgExtensionAssetsPath')+'/Cheevos/images/delete.png').attr('title', mw.message('delete_condition').escaped()).addClass('delete_condition');
