...
class CheevosWikiPointLog extends CheevosModel {
	...
	public function __construct( array $data = null ) {
		...
		$this->container['page_id'] = isset( $data['page_id'] ) &&
									  is_int( $data['page_id'] ) ? $data['page_id'] : 0;
		$this->container['revision_id'] = isset( $data['revision_id'] ) &&
										  is_int( $data['revision_id'] ) ? $data['revision_id'] : 0;
		$this->container['points'] = isset( $data['points'] ) &&
									 is_int( $data['points'] ) ? $data['points'] : 0;
		...
		$this->container['size_diff'] = isset( $data['size_diff'] ) &&
										is_int( $data['size_diff'] ) ? $data['size_diff'] : 0;
		$this->container['timestamp'] = isset( $data['timestamp'] ) &&
										is_int( $data['timestamp'] ) ? $data['timestamp'] : 0;
		$this->container['user_id'] = isset( $data['user_id'] ) &&
									  is_int( $data['user_id'] ) ? $data['user_id'] : 0;
	}
}
