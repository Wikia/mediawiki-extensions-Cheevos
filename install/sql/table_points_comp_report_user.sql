...
ALTER TABLE /*_*/points_comp_report_user ADD PRIMARY KEY (`ru_id`), ADD UNIQUE KEY `report_id_global_id` (`report_id`,`global_id`), ADD KEY `start_time_end_time` (`start_time`,`end_time`);

ALTER TABLE /*_*/points_comp_report_user MODIFY `ru_id` int(14) NOT NULL AUTO_INCREMENT;